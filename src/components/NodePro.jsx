  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-6 lg:h-[calc(100vh-200px)]">
      ...
      <div className="lg:col-span-1 lg:overflow-y-auto lg:pr-2">
        <h3 className="text-base lg:text-lg font-bold text-emerald-400 mb-2 lg:mb-4 flex items-center gap-2">
      ...
      <div className="lg:col-span-3 lg:overflow-y-auto lg:pr-2">
        <div className="mb-4 lg:mb-6">
          <div className="flex items-center gap-3 mb-2">
            <SectionIcon className="w-6 h-6 lg:w-8 lg:h-8 text-emerald-400" />
            <h2 className="text-xl lg:text-3xl font-bold text-emerald-400">{currentSection.title}</h2>
          </div>
