...
export const translations = {
    common: {
        es: {
            ...
            searchTabsList: 'Clean Code, SOLID, Patterns, Architecture, JS/TS, Node, Java, Spring, GraphQL, React, Angular, Cloud, Containers, Testing, Databases, Security, Python, Kotlin',
