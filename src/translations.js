...
export const translations = {
    common: {
        es: {
            ...
            searchTabsList: 'Clean Code, SOLID, Patterns, Architecture, JS/TS, Node, Java, Spring, GraphQL, React, Angular, Cloud, Containers, Testing, Databases, Security, Python, Kotlin, DSA, AI/LLM, API Design, Git, Kafka',
            ...
            categoryDatabases: 'Bases de Datos & Seguridad',
            categoryFavorites: 'Mis Favoritos',
            categoryAI: 'AI & LLMs',
            ...
            studyModeOn: 'Modo Estudio ON',
            studyModeOff: 'Modo Estudio OFF',
            studyModeHint: 'El código se oculta para que lo recuerdes',
            lightMode: 'Modo Claro',
            darkMode: 'Modo Oscuro',
            noFavorites: 'No tienes favoritos aún',
            noFavoritesHint: 'Marca ★ en cualquier tab para agregarlo aquí',
            tabTesting: 'Testing Pro',
            tabDatabases: 'Databases Pro',
            tabSecurity: 'Security Pro',
            tabPython: 'Python Pro',
            tabKotlin: 'Kotlin Pro',
            progressVisited: 'visitado',
            progressFavorited: 'favorito',
        },
        en: {
            appTitle: 'FullStack Guide',
            ...
            categoryFrontend: 'Frontend',
            categoryCloudDevops: 'Cloud/DevOps',
            categoryDatabases: 'Databases & Security',
            ...
            studyModeOn: 'Study Mode ON',
            studyModeOff: 'Study Mode OFF',
            studyModeHint: 'Code is hidden so you can recall it',
            lightMode: 'Light Mode',
            darkMode: 'Dark Mode',
            noFavorites: 'No favorites yet',
            noFavoritesHint: 'Star ★ any tab to add it here',
            tabTesting: 'Testing Pro',
            tabDatabases: 'Databases Pro',
            tabSecurity: 'Security Pro',
            tabPython: 'Python Pro',
